...
public:
  ...
  virtual void InitiateGameConnection(void *,int,int,int,unsigned int,unsigned short,bool);
  virtual void InitiateGameConnectionOld(void *,int,int,int,unsigned int,unsigned short,bool,void *,int);
  virtual void TerminateGameConnection(unsigned int,unsigned short);
  virtual void TerminateAppMultiStep(unsigned int,unsigned int);
  ...
  virtual void ResetPassword(char const*,char const*,char const*,char const*,char const*,char const*);
  virtual void ValidatePasswordResetCodeAndSendSms(char const*,char const*);
  ...
  virtual void BUpdateAppOwnershipTicket(unsigned int,bool,bool);
  ...
  virtual void GetAccountName(int,char *,unsigned int);
  ...
  virtual void TestAvailablePassword(unsigned char const*,int);
  virtual void GetSteamGuardDetails(void);
  virtual void GetTwoFactorDetails(void);
  virtual void BHasTwoFactor(void);
  virtual void RecoverAuthenticator(char const*,char const*,char const*,char const*,char const*);
  ...
  virtual void RequestAccountResetDetails(char const*,char const*);
  virtual void FindAccountsByEmailAddress(char const*);
  virtual void FindAccountsByCdKey(char const*);
  virtual void GetNumAccountsWithEmailAddress(char const*);
  virtual void IsAccountNameInUse(char const*);
  ...
  virtual void SpawnProcess(char const*,char const*,unsigned int,char const*,int,char const*,unsigned int,unsigned int);
  ...
  virtual void GetMarketingMessage(int,unsigned long long *,char *,int,int *);
  virtual void GetAuthSessionTicket(void *,int,unsigned int *);
  virtual void BeginAuthSession(void const*,int,int);
  virtual void EndAuthSession(int);
  virtual void CancelAuthTicket(unsigned int);
  virtual void IsUserSubscribedAppInTicket(int,unsigned int);
  virtual void AdvertiseGame(int,int,unsigned int,unsigned short);
  ...
  virtual void RequestPasswordChangeEmail(char const*,int);
  virtual void ChangePasswordWithCode(char const*,char const*,char const*);
  virtual void RequestEmailChange(char const*,char const*);
  virtual void ChangeEmailWithCode(char const*,char const*,char const*,char const*,char const*);
